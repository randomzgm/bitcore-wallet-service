...
AddressManager.fromObj = function(obj) {
  ...
  x.coldStakingAddressIndex = obj.coldStakingAddressIndex;
...
AddressManager.prototype.getNewColdStakingAddressPath = function() {
  var ret = 'm/' +
    (this.derivationStrategy == Constants.DERIVATION_STRATEGIES.BIP45 ? this.copayerIndex + '/' : '') +
    '0/' + this.coldStakingAddressIndex;
  this.coldStakingAddressIndex++;
  return ret;
};
